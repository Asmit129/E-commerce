...
const CartPanel = () => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 right-0 h-full w-full max-w-md bg-[var(--bg-main)] border-l border-[var(--border-glass)] z-[70] flex flex-col shadow-[-20px_0_50px_rgba(0,0,0,0.8)]">
