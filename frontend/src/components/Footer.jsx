...
import { ShieldCheck, Instagram, Twitter, Mail, Phone } from 'lucide-react';

const Footer = () => {
  return (
    <footer className="bg-[var(--bg-black)] border-t border-[var(--border-glass)] pt-12 sm:pt-16 pb-8 text-[var(--text-muted)]">
          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4 sm:mb-6">
              <img
                src="/logo.png"
                alt="ForgeVogue logo"
                className="h-8 w-8 sm:h-10 sm:w-10 object-contain rounded-full shadow-[0_0_10px_rgba(var(--gold-rgb),0.4)]"
              />
