          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            <form onSubmit={handleSearchSubmit} className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full bg-[var(--glass-light)] border border-[var(--border-glass)] rounded-full py-2.5 pl-10 pr-4 text-sm text-[var(--text-main)] placeholder-[var(--text-muted)] focus:outline-none focus:border-[var(--accent-gold)] focus:ring-1 focus:ring-[var(--accent-gold)] transition-all"
              />
            </form>
            <button 
              onClick={() => setShowFilters(!showFilters)}
              className="md:hidden flex items-center justify-center gap-2 bg-[var(--glass-light)] border border-[var(--border-glass)] rounded-full py-2.5 px-6 text-sm text-[var(--text-main)] hover:bg-[var(--glass-medium)] transition-colors"
            >
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <aside className={`w-full md:w-64 shrink-0 ${showFilters ? 'block' : 'hidden md:block'}`}>
            <div className="sticky top-32 space-y-8">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-colors ${
                      rarity === "" 
                        ...
                        : "bg-transparent border-[var(--border-glass)] text-[var(--text-muted)] hover:border-[var(--border-glass-strong)] hover:text-[var(--text-main)]"
                    }`}
                  >
                    Any
                  </button>
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--accent-gold)]/20 rounded-xl p-5 mt-8">
          ...
          <main className="flex-1 min-w-0">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-64 text-center border border-[var(--border-glass)] rounded-2xl bg-[var(--glass-light)]">
                  ...
                  <div key={p._id} className="group relative">
                    <div className="h-full flex flex-col">
                      ...
                      {user && (
                        ...
                        >
                          <Heart className={`w-4 h-4 ${watchlist?.includes(p._id) ? "fill-[var(--accent-gold)] text-[var(--accent-gold)]" : "text-[var(--text-main)]"}`} />
                        </button>
                      )}
